angular.module('libshareApp')
    ...
    .directive("imgUpload",['$http', '$compile', 'StringUtils',function($http,$compile, StringUtils){
        return {
            restrict : 'AE',
            scope : {
                url : "@",
                    ...
                    '<div class="preview clearfix">'+
                        '<div class="previewData clearfix" ng-repeat="data in previewData track by $index">'+
                            ...
                            '<div class="previewControls">'+
                                '<span ng-click="upload(data)" class="circleSelectUser upload">'+
                                    '<i class="fa fa-check"></i>'+
                                '</span>'+
                                '<span ng-click="remove(data)" class="circleSelectUser remove">'+
            ...
            link : function(scope,elem,attrs){
                ...
                if (!StringUtils.isEmpty(scope.multiple) && scope.multiple == 'true') {
                    attrs.push('multiple');
                }
