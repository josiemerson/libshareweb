...
.value('taTranslations', {
    ...
    quote: {
        tooltip: 'Citar / desmarcar seleção ou parágrafo'
    },
    undo: {
        tooltip: 'Desfazer'
    },
    ...
    justifyLeft: {
        tooltip: 'Alinhar texto esquerda'
    },
    justifyRight: {
        tooltip: 'Alinhar texto direita'
    },
    justifyFull: {
        tooltip: 'Justifique o texto'
    },
    justifyCenter: {
        tooltip: 'Texto centro'
    },
    indent: {
        tooltip: 'Aumentar recuo'
    },
    outdent: {
        tooltip: 'Recuar devagar'
    },
    clear: {
        tooltip: 'Limpar formatação'
    },
    insertImage: {
        dialogPrompt: 'Insira um URL da imagem para inserir',
        tooltip: 'Inserir Imagem',
        hotkey: 'a tecla de atalho - possivelmente dependente do idioma ... para alguma implementação futura'
    },
    insertVideo: {
        tooltip: 'Insira um video',
        dialogPrompt: 'Por favor, insira um URL do youtube para incorporar'
    },
    insertLink: {
        tooltip: 'Inserir / editar link',
        dialogPrompt: "Por favor insira um URL para inserir"
    },
    editLink: {
        reLinkButton: {
            tooltip: "Revincular"
        ...
        targetToggle: {
            buttontext: "Abra em uma nova janela"
        }
    },
    wordcount: {
        tooltip: 'Exibir contagem de palavras'
    },
        charcount: {
        tooltip: 'Contagem de caracteres de exibição'
    }
})
